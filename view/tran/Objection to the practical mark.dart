...
class Objection_to_the_practical_mark extends StatefulWidget {
  const Objection_to_the_practical_mark({Key? key}) : super(key: key);

  @override
  _Objection_to_the_practical_markState createState() => _Objection_to_the_practical_markState();
}

class _Objection_to_the_practical_markState extends State<Objection_to_the_practical_mark> {
  ...
  Widget build(BuildContext context) {
                  ...
                  children: [
                    Center(
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              "معاملة اعتراض على علامة العملي",
                              style: TextStyle(
                                  fontSize: 29.0,
                                  color: Colors.white,
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        controller: transictionnameController..text="اعتراض عملي",
                            ...
                            onPressed: () async {
                              if (formkey.currentState!.validate()) {
                                cubit.makeTran(tran_name: transictionnameController.text,
                                    father:fathernameController.text??"true",
    ...
    //         crossAxisAlignment: CrossAxisAlignment.start,
    //         children: [
    //           Center(child: Text("معاملة اعتراض على علامة العملي  ", style: TextStyle(fontSize: 29.0,color:
    ...
    //                     'اسم المعاملة',
    //                   ),
    //                   hintText: "معاملة اعتراض على علامة العملي  ",
    //
    //                   labelStyle: TextStyle(color: Colors.black)),
    //             ),
    //           ),
